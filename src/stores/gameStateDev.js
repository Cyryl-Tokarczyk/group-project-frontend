...
export const useGameStateStore = defineStore('gameState', () => {
  ...
  const actionCards = ref([{id: 1,des: "Karta A 1",color: "rgb(50,50,100)"},{id: 2,des: "Karta A 2",color: "rgb(100,50,0)"},{id: 3,des: "Karta A 3",color: "rgb(50,150,50)"}])
  const reactionCards = ref([{id: 1,des: "Karta R 1",color: "rgb(150,50,100)"},{id: 2,des: "Karta R 2",color: "rgb(50,150,100)"},{id: 3,des: "Karta R 3",color: "rgb(50,50,150)"}])
